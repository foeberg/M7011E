  ...
  render() {
    return (
        <div className="coalPowerPlantBox">
            ...
            <div style={{margin: "1.0em"}}><b>Status:</b> {this.state.status}<span className="dot" style={this.dotStyle()}></span><span button type="submit" className="exitButton" style={{float: "none"}} onClick={()=>{alert("hej")}}>{this.startStop()}</span></div>
